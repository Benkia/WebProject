...
//        [HttpPost]
//        public async Task<ActionResult> Create([Bind(Include = "ID,Title,FanID,SiteAddress,Text,Picture,Video")] Post post)
//        {
...
//                Claim FacebookAccessToken = (System.Security.Claims.Claim)HttpContext.Session["FacebookAccessToken"];

//                if (FacebookAccessToken != null)
//                    shareFacebookPost(FacebookAccessToken.Value);
...
//        private void shareFacebookPost(string token)
//        {
